...
/******/ 	var hotCurrentHash = "559f99711b7ec3bf416f"; // eslint-disable-line no-unused-vars
...
/******/ 	__webpack_require__.p = "/msphStatic/";
/******/
/******/ 	// __webpack_hash__
...
* }])
*/
var elementPopup = function () {
    var _queue = [];
    var init = function init(opt) {
        for (var i = 0; i < opt.length; i++) {
            var el = opt[i].el;
            var popup = opt[i].popup;
            _queue.push(new elClass(opt[i]));
        };
    };

    var elClass = function () {
        function elClass(opt) {
            (0, _classCallCheck3.default)(this, elClass);
        ...
        (0, _createClass3.default)(elClass, [{
            key: 'init',
            value: function init() {
                var that = this;
                this.el.each(function (index) {
                    var $el = that.el.eq(index);
                    var $popup = that.popup.eq(index);
                    if ($el.hasClass('init')) {
                        return;
                    }
            ...
            key: 'classSelector',
            value: function classSelector(dom) {
                return $('.' + dom);
            }
        }]);
        return elClass;
    ...
    var elementFun = function () {
        //父类 定义属性和方法
        function elementFun(el, popup, move) {
            (0, _classCallCheck3.default)(this, elementFun);
        ...
        (0, _createClass3.default)(elementFun, [{
            key: 'moveShapeFun',
            value: function moveShapeFun($el) {
                //判断是弹窗的形式
    ...
    var clickPopup = function (_elementFun) {
        (0, _inherits3.default)(clickPopup, _elementFun);

        function clickPopup(el, popup, move) {
            (0, _classCallCheck3.default)(this, clickPopup);

            var _this = (0, _possibleConstructorReturn3.default)(this, (clickPopup.__proto__ || (0, _getPrototypeOf2.default)(clickPopup)).call(this, el, popup, move));

            _this.bind();
            return _this;
        }

        (0, _createClass3.default)(clickPopup, [{
            key: 'bind',
            value: function bind() {
                var _this2 = this;

                var that = this;
                this.elDom.on('click', function (index) {
                    var $this = that.elDom.eq(index);
                    (0, _get3.default)(clickPopup.prototype.__proto__ || (0, _getPrototypeOf2.default)(clickPopup.prototype), 'moveShapeFun', _this2).call(_this2, $this);
                });
            }
        }]);
        return clickPopup;
    ...
    var middleFun = function (_elementFun2) {
        (0, _inherits3.default)(middleFun, _elementFun2);

        function middleFun(el, popup, move, $el) {
            (0, _classCallCheck3.default)(this, middleFun);

            var _this3 = (0, _possibleConstructorReturn3.default)(this, (middleFun.__proto__ || (0, _getPrototypeOf2.default)(middleFun)).call(this, el, popup, move));
        ...
        (0, _createClass3.default)(middleFun, [{
            key: 'init',
            value: function init() {
                var _this4 = this;
            ...
            key: 'show',
            value: function show() {
                (0, _get3.default)(middleFun.prototype.__proto__ || (0, _getPrototypeOf2.default)(middleFun.prototype), 'bodyCss', this).call(this, true);
                this.popupDom.show();
            }
        }, {
            key: 'hide',
            value: function hide() {
                (0, _get3.default)(middleFun.prototype.__proto__ || (0, _getPrototypeOf2.default)(middleFun.prototype), 'bodyCss', this).call(this, false);
                this.$el.prevObject.removeClass('classActive');
                this.popupDom.hide();
            }
        }]);
    ...
    var rightFun = function (_elementFun3) {
        (0, _inherits3.default)(rightFun, _elementFun3);

        function rightFun(el, popup, move, $el) {
            (0, _classCallCheck3.default)(this, rightFun);

            var _this5 = (0, _possibleConstructorReturn3.default)(this, (rightFun.__proto__ || (0, _getPrototypeOf2.default)(rightFun)).call(this, el, popup, move));

            _this5.$el = $el;
            _this5.popupContent = _this5.popupDom.find('.popup_content');
            _this5.contentWidth = _this5.popupContent.outerWidth(true);
            _this5.winWidth = $(window).width();
            _this5.init();
            return _this5;
        }

        (0, _createClass3.default)(rightFun, [{
            key: 'init',
            value: function init() {
                var that = this;
                this.show();
            ...
            value: function show() {
                var that = this;
                (0, _get3.default)(rightFun.prototype.__proto__ || (0, _getPrototypeOf2.default)(rightFun.prototype), 'bodyCss', this).call(this, true);
                this.popupDom.show();
                setTimeout(function () {
            ...
            key: 'hide',
            value: function hide() {
                (0, _get3.default)(rightFun.prototype.__proto__ || (0, _getPrototypeOf2.default)(rightFun.prototype), 'bodyCss', this).call(this, false);
                this.popupDom.hide();
    ...
    var bottomFun = function (_elementFun4) {
        (0, _inherits3.default)(bottomFun, _elementFun4);

        function bottomFun(el, popup, move, $el) {
            (0, _classCallCheck3.default)(this, bottomFun);

            var _this6 = (0, _possibleConstructorReturn3.default)(this, (bottomFun.__proto__ || (0, _getPrototypeOf2.default)(bottomFun)).call(this, el, popup, move));

            _this6.$el = $el;
            _this6.popupContent = _this6.popupDom.find('.popup_content');
            _this6.contentHeight = _this6.popupContent.outerHeight(true);
            //this.winWidth = $(window).width();
            _this6.init();
            return _this6;
        }

        (0, _createClass3.default)(bottomFun, [{
            key: 'init',
            value: function init() {
                var _this7 = this;
            ...
            value: function show() {
                var that = this;
                (0, _get3.default)(bottomFun.prototype.__proto__ || (0, _getPrototypeOf2.default)(bottomFun.prototype), 'bodyCss', this).call(this, true);
                this.popupDom.show();
                setTimeout(function () {
            ...
            key: 'hide',
            value: function hide() {
                (0, _get3.default)(bottomFun.prototype.__proto__ || (0, _getPrototypeOf2.default)(bottomFun.prototype), 'bodyCss', this).call(this, false);
                this.popupDom.hide();
...
$(function () {
    ...
    var FastClick = __webpack_require__(38);
    FastClick.attach(document.body);
    /*导入页面需要依赖的模块*/
    var elementPopup = __webpack_require__(87);
    var tabContent = __webpack_require__(93);
    ...
    var pageJs = {
        ...
        conClickFun: function conClickFun() {
            var that = this;
            this._queue = [];
    ...
    var callback = function callback() {//点击完成按钮 后端操作函数
