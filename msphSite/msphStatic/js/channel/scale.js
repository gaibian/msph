...
$(function () {
  ...
  var pageJs = function () {
    ...
    var pageFun = function () {
      //父类
      function pageFun(btn, $selector) {
        (0, _classCallCheck3.default)(this, pageFun);
      ...
      (0, _createClass3.default)(pageFun, [{
        key: 'judgeAddDom',
        value: function judgeAddDom() {
          var _this = this;

          //判断是否可以增加层级方法
          this.listDom = this.pageDom.find('.level_list_box');
          this.listLength = this.listDom.length;
          this.listDom.each(function (index) {
            var $this = _this.listDom.eq(index);
            var inputDom = $this.find('input');
            inputDom.each(function (index) {
              var $input = inputDom.eq(index);
              if ($.trim($input.val()) === '') {
        ...
        value: function addDom() {
          //添加层级dom方法
          var chNum = this.listLength + 1;
          var creatDom = $('<div class="level_list_box">' + '<div class="level_title"><h1 class="title">LV.<span class="title_num">' + chNum + '</span></h1><div class="delete_btn">删除</div></div>' + '<div class="level_content"><div class="input_box"><label class="input_title">月订单总额</label>' + '<input class="money_input" type="text" placeholder="" name="money[]"><em class="unit">万元</em></div>' + '<div class="input_box"><label class="input_title">返佣</label><input class="unit_input" type="text" name="back_rate[]">' + '<em class="unit">%</em></div></div></div>');
          this.pageDom.append(creatDom);
        }
      }, {
        key: 'remindDom',
        value: function remindDom() {
          var _this2 = this;
    ...
    var listChildFun = function () {
      //每个单独层级操作的类
      function listChildFun(el, app) {
        (0, _classCallCheck3.default)(this, listChildFun);
      ...
      (0, _createClass3.default)(listChildFun, [{
        key: 'bind',
        value: function bind() {
          var _this3 = this;
          ...
          this.deleteBtn.on('click', function () {
            ...
            _this3.el.remove();
            _this3.app.listDom = _this3.app.pageDom.find('.level_list_box');
            _this3.app.listDom.each(function (index) {
              var $this = _this3.app.listDom.eq(index);
              $this.find('.title_num').text(index + 1);
            });
            _this3.judgeIndex();
            _this3.app._queue.splice(_this3.index - 1, 1);
          });
          this.moneyInput.on('blur', function () {
            _this3.judgeInput('.money_input', _this3.moneyInput);
          });
          this.unitInput.on('blur', function () {
            _this3.judgeInput('.unit_input', _this3.unitInput);
          });
        }
      }, {
        key: 'judgeIndex',
        value: function judgeIndex() {
          //重置当前dom的index下标
          this.numDom = this.el.find('.title_num');
          this.index = Number(this.numDom.text());
        }
        ...
        key: 'judgeInput',
        value: function judgeInput(otherInput, $input) {
          //光标输入判断
          this.judgeIndex();
          if (this.index === 1) {
            //表示是第一个
            ...
            if (this.index === this.app.listDom.length) {
              //只需要比上一个值大
              var prevDom = this.app.listDom.eq(this.index - 2).find(otherInput);
              ...
              //需要跟上下级比较
              var _prevDom = this.app.listDom.eq(this.index - 2).find(otherInput);
              var nextDom = this.app.listDom.eq(this.index).find(otherInput);
              if ($input.val() <= _prevDom.val()) {
                this.app.remindContent = '请输入比上一级大的数字';
                this.app.remindDom();
                $input.val('');
                return false;
    ...
    var listFun = function (_pageFun) {
      (0, _inherits3.default)(listFun, _pageFun);

      //子类
      function listFun(btn, $selector) {
        (0, _classCallCheck3.default)(this, listFun);

        var _this4 = (0, _possibleConstructorReturn3.default)(this, (listFun.__proto__ || (0, _getPrototypeOf2.default)(listFun)).call(this, btn, $selector));
      ...
      (0, _createClass3.default)(listFun, [{
        key: 'init',
        value: function init() {
          var _this5 = this;
          ...
          this.listDom = this.pageDom.find('.level_list_box');
          this.listDom.each(function (index) {
            var $this = _this5.listDom.eq(index);
            $this.find('.title_num').text(index + 1);
            _this5._queue.push(new listChildFun($this, _this5));
          });
        }
      }, {
        key: 'bind',
        value: function bind() {
          ...
          this.btn.on('click', function () {
            _this6.judgeAddDom();
            _this6.listDom = _this6.pageDom.find('.level_list_box');
            var lastDom = _this6.listDom.eq(_this6.listDom.length - 1);
            _this6._queue.push(new listChildFun(lastDom, _this6));
          });
        }
      }]);
      return listFun;
