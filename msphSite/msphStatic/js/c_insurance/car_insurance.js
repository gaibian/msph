...
var _betterScroll = __webpack_require__(100);
...
$(function () {
  ...
  var plateNumber = __webpack_require__(102);
  ...
  var calcHeight = function calcHeight() {
    ...
    var btmNavHeight = $('.nav_bottom_box').height();
    $('.main').css({
  ...
  var scrollB = new _betterScroll2.default('.main', {
    scrollX: false,
    scrollY: true,
    click: true
  });
  ...
  scrollB.on('beforeScrollStart', function () {
    input.blur();
  });
  ...
  /*订单弹窗*/
  var carOrderPopup = $('.car_order_popup_box');
  var carOrderCloseBtn = carOrderPopup.find('.close_btn');
  ...
  var cityCodeList = citylist;
  var cityResult = document.getElementById('cityResult');
  var choiceBtn = $('.choice_btn');
...
var plateNumber = function () {
    ...
    init.prototype.bind = function () {
        var that = this;
        for (var i = 0; i < this.provinceDomA.length; i++) {
            this.provinceDomA[i].onclick = function (event) {
                for (var _i = 0; _i < that.provinceDomA.length; _i++) {
                    that.provinceDomA[_i].classList.remove('active');
                }
                this.classList.add('active');
                for (var _i2 = 0; _i2 < that.enDomA.length; _i2++) {
                    that.enDomA[_i2].classList.remove('active');
                }
            };
        };

        for (var _i3 = 0; _i3 < this.enDomA.length; _i3++) {
            this.enDomA[_i3].onclick = function (event) {
                for (var _i4 = 0; _i4 < that.enDomA.length; _i4++) {
                    that.enDomA[_i4].classList.remove('active');
                };
                this.classList.add('active');
                that.dataShow();
            };
