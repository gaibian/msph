...
$(function () {
    ...
    /*页面js*/
    var pageScrollBox = $('.page_scroll_box');
    var headerNav = $('.page_header_title');
    var scrollPosition = $('.scroll_position');
    var bottomBtnBox = $('.bottom_btn_box');
    ...
    var inputFocus = {
        init: function init(dom) {
            ...
            this.inputListBox.each(function (index) {
    ...
    window.verify = __webpack_require__(163);

    var inputListBox = $('.input_list_box');
...
var formVail = function () {
    ...
    var bgBind = function (_validation) {
        ...
        function bgBind(obj) {
            ...
            var _this = (0, _possibleConstructorReturn3.default)(this, (bgBind.__proto__ || (0, _getPrototypeOf2.default)(bgBind)).call(this, obj));

            (0, _get3.default)(bgBind.prototype.__proto__ || (0, _getPrototypeOf2.default)(bgBind.prototype), 'init', _this).call(_this);
            _this.init();
            _this.bind();
        ...
        (0, _createClass3.default)(bgBind, [{
            key: 'init',
            value: function init() {
                var that = this;
            ...
            key: 'checkIsOK',
            value: function checkIsOK(This, type, index) {
                //对每个input进行验证
                var text = This.val();
