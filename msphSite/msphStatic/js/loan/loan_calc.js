...
$(function () {
    ...
    var calcParent = function () {
        function calcParent(dom1, dom2) {
            (0, _classCallCheck3.default)(this, calcParent);
        ...
        (0, _createClass3.default)(calcParent, [{
            key: 'init',
            value: function init() {
                var that = this;
                //默认选择到等本等息
            ...
            value: function bind() {
                var that = this;
                this.activeBtn.each(function (index) {
                    var $this = that.activeBtn.eq(index);
                ...
                //点击计算事件
                this.calcBtn.on('click', function () {
                    //先判断按什么方式计算
                    that.emtpyFun();
                    if (that.flag) {
            ...
            key: 'calcFunB',
            value: function calcFunB() {
                //等本等息计算函数
                var allMoneyInputVal = Number(this.allMoneyInput.val());
                var monthInputVal = Number(this.monthInput.val());
                var interMonthInputVal = Number(this.interMonthInput.val()) / 1000;
            ...
            key: 'dataShow',
            value: function dataShow(num1, num2, num3, num4) {
            ...
            key: 'resetFun',
            value: function resetFun() {
                //重置事件执行函数
                var that = this;
                this.allInput = this.domEnterBox.find('input');
                this.allInput.each(function (index) {
                    var $this = that.allInput.eq(index);
                    $this.val('');
                });
                this.domShowBox.find('.num').each(function (index) {
                    var $this = that.domShowBox.find('.num').eq(index);
                    $this.text('0.00');
                });
            }
        }, {
            key: 'activeFun',
            value: function activeFun() {
                //判断是选择等额本息 还是 先息后本
                var that = this;
                this.activeBtn.each(function (index) {
                    var $this = that.activeBtn.eq(index);
...
var scrollTo = function () {
    ...
    var scrollToFun = function () {
        function scrollToFun(obj) {
            (0, _classCallCheck3.default)(this, scrollToFun);
        ...
        (0, _createClass3.default)(scrollToFun, [{
            key: 'selectorFun',
            value: function selectorFun(dom) {
                return $('.' + dom);
            }
        }, {
            key: 'toTop',
            value: function toTop(dom) {
                //方法获取到距离顶部的距离
                var iTop = 0;
                while (dom) {
                    iTop += dom.offsetTop;
            ...
            value: function bind() {
                ...
                this.btn.on('click', function () {
                    var top = that.toTop(that.positionDom[0]) - 44;
