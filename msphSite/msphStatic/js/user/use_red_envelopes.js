...
$(function () {
  ...
  var fool = function () {
    function fool(dom) {
      (0, _classCallCheck3.default)(this, fool);
    ...
    (0, _createClass3.default)(fool, [{
      ...
      value: function bind() {
        ...
        this.addBtn.on('click', function () {
          var maxNum = Number(that.maxEnveNum.text().replace('￥', ''));
          var newAllNum = Number(that.allEnveNum.text().replace('￥', ''));
      ...
      key: 'calcFun',
      value: function calcFun() {
        var that = this;
        var maxNum = Number(that.maxEnveNum.text().replace('￥', ''));
        this.addNumArr = [];
        $('.envelopes_list_box').each(function () {
          var val = $(this).find('.num_val input').attr('data-num');
